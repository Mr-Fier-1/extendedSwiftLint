//
//  AccessibilityLabelForImageRule.swift
//  SwiftLintExtraRules
//
//  Created by Jann‘s AWL Mac on 26.01.2024.
//
...
struct AccessibilityLabelForTestRule: ASTRule, OptInRule {
    var configuration = SeverityConfiguration<Self>(.warning)

    static let description = RuleDescription(
        identifier: "accessibility_label_test",
        name: "Accessibility Label Test",
